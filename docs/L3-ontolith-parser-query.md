...
| query | 21 | SELECT/JOIN/OPTIONAL/UNION/FILTER/BIND/VALUES/CONSTRUCT/ASK/DISTINCT/ORDER/LIMIT/PREFIX/Explain/timeout/cancel/txn/hint |
| storage 回归 | 24 | 绿 |
| core 回归 | 11 | 绿 |
...
1. **属性路径**、**子查询**、**EXISTS/NOT EXISTS**、**聚合/GROUP BY/HAVING**、**SERVICE** 未实现。  
